...
void mysql_connect::test()
{
	try 
	{
	  boost::shared_ptr<sql::Driver> driver;
	  ...
	  // delete pstmt;
	  // delete con;
	  string query="select * from t_currency_daily_exchange_rate where exchange_rate_id='CVUOQYIEF8KDDPVIUQW8' and createBy='exchange_gw'";
